      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-yellow-400/20 border border-yellow-400/30 text-yellow-600 dark:text-yellow-400 text-xs font-semibold px-2.5 py-0.5">
              Marketplace
            </span>
          </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="rounded-xl bg-emerald-500/15 border border-emerald-500/30 px-2.5 py-1 text-center shrink-0">
                        ...
                        <span className="block text-sm font-semibold text-emerald-600 dark:text-emerald-300">
                          {commissionPercent}%
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-5 pt-3 border-t border-slate-100 dark:border-separator flex items-center gap-2">
                    ...
                    {shop.collaborationStatus === 'active' ? (
                      ...
                      <Button
                        ...
                        className="h-9 px-3.5 bg-yellow-400 font-semibold text-black hover:bg-yellow-300 text-xs"
                      >
                        {isRequesting ? (
