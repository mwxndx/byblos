...
export function DetectionCard({ earning, formatCurrency, onRelease, onReverse }: DetectionCardProps) {
  ...
  return (
    <Card className="bg-[#0A0A0A]/40 backdrop-blur-2xl border border-orange-500/20 rounded-card overflow-hidden shadow-2xl group hover:border-orange-500/40 transition-all duration-500">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2 flex-wrap">
              ...
              {earning.order_number && (
                <div className="px-3 py-1 bg-white/5 rounded-full border border-white/10 text-[10px] font-semibold text-gray-300">
                  Order #{earning.order_number}
                </div>
              )}
            </div>
            <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest opacity-60">
      ...
      <CardContent className="p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest opacity-40">Creator</p>
            <div className="flex items-center gap-4 bg-white/[0.02] p-4 rounded-2xl border border-white/5">
              ...
              <div>
                <p className="text-base font-semibold text-white tracking-tight">{earning.creator_name || `Creator #${earning.creator_id}`}</p>
            ...
            {earning.buyer_id && (
              <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest ml-1">
          ...
          <div className="space-y-4">
            <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest opacity-40">Held amount</p>
            ...
            <div className="flex items-center gap-2 text-[10px] font-semibold text-gray-500 uppercase tracking-widest ml-1">
